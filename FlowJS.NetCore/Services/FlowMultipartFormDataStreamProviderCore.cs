...
{
    public class FlowMultipartFormDataStreamProviderCore : MultipartFormDataStreamProvider
    {
        ...
        public FlowMultipartFormDataStreamProviderCore(string path) : base(path)
        { }
